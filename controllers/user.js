...
//     if(!Firstname ||!Lastname || !nick ||!email ||!password) return res.status(400).json({msg: 'Todos los campos son obligatorios'})
...
//     return response.status(201).json('! usuario creado! , para continuar con el registro verificar su correo :)')
// })
